...
#include "stdio.h"  /* for vfprintf() */
  ...
  /**************************************************************************
   *
   * 'dlg' uses output handlers to control how and where logs messages are
  ...
  /**************************************************************************
   *
   * For printing the name of `FT_COMPONENT` along with the actual logs we
  ...
  /**************************************************************************
   *
   * A function to print logs data using a custom callback logging function

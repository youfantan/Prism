...
// the logs/assertion levels below which logs/assertions are ignored
...
// the arguments the logs/assertions macros are called with. Must return a const char*
...
// The returned const char* has to be valid until the dlg logs/assertion ends.
...
// Represents the importance of a logs/assertion call.
enum dlg_level {
...
// Holds various information associated with a logs/assertion call.
...
// Sets the handler that is responsible for formatting and outputting logs calls.
